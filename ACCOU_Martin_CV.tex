...
\cventry{2024, 6 mois}{Stage en sciences des données}{\href{https://d3s.ai/fr/}{D3S}}{Grenoble}{France}{\begin{itemize}
    \item Développement d'un outil de classification de pièces 3D basé sur des réseaux de neurones de graphes (GNN).
...
\cvitem{Langages}{C, C++, Rust, Java, Python, HTML/CSS, JavaScript, Vue.js, Nuxt.js, \LaTeX.}
