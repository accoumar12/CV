...
\faLinkedinSquare {https://www.linkedin.com/in/martin-accou}
...
\cventry{2023, 6 mois}{Stage en sciences des données}{\href{https://reuniwatt.com/fr}{Reuniwatt}}{Saint-Pierre}{France}{\begin{itemize}
    ...
    \item Introduction aux défis liés à la production par rapport à la recherche et liés à l'industrialisation des modèles de machine learning (MLOps).
    \end{itemize}}
...
\cvitem{Outils de la data}{Pandas, Scikit-learn, PyTorch, TensorFlow, SQL, Spark, Docker, Kubernetes.}
...
\cvitem{Loisirs}{Géopolitique, aéronautique (BIA), aérospatiale, compétitions Kaggle.}
